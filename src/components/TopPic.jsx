        ...
        <div className="py-2 relative mx-1">
            ...
            <div className="absolute container top-0 text-center md:flex md:justify-between md:text-left xl:w-max-[1540px]">
                ...
                <div className="w-max mx-auto">
                    <p className="pt-2 text-[13p} text-slate-500 md:text-right md:pl-36 md:pt-10 lg:pl-96 md:text-[15px] xl:w-[1100px] xl:text-[20px]">Selamat datang di Website ManjoPasiar <br />
