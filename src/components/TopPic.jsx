...
const TopPic = () => {
    return(
        ...
        <div className="py-2 relative mx-1">
            <img src={manado} alt="" className="rounded-lg md:h-auto lg:w-[1100px] xl:w-[2600px] xl:h-[790px]"/>
            <div className="absolute container top-0 text-center md:flex md:justify-between md:text-left xl:w-max-[1540px]">
                ...
                <div className="w-max mx-auto">
                    <p className="pt-2 text-[13px] text-white md:text-right md:pl-36 md:pt-10 lg:pl-96 xl:pl-0 xl:pt-[75px] md:text-[15px] xl:w-[550px] xl:text-[22px] 2xl:w-[1650px]">Selamat datang di Website ManjoPasiar <br />
