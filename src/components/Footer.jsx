...
const Footer = () => {
    return(
        <>
        <div className="rounded-xl bg-[#1746A2] py-3 font-medium mx-1 text-white">
            <div className="flex-cols px-4 rouunded-xl md:flex justify-between">
                ...
                <div className="md:my-auto">
                    ...
                    <div className="bg-[#113579] rounded-lg mt-2 md:px-4 md:py-2 mb-2 py-2">
        ...
        <div className="bg-[#113579] text-center mt-2 rounded-t-xl text-white">
            <p className="font-semibold text-[12px] md:text-[20px]">Copyright © 2022 All Right Reserved || ManjoPasiar</p>
        </div>
    </>
    )
};
