...
const DestiNasi = ({img, destinasi}) => {
    ...
    const getWisata1 = async() => {
        ...
        const getWisata3 = async() => {
            const response = await axios.get("http://localhost:5000/wisata/3");
        ...
        <div className="md:grid md:grid-cols-2">
            <div className="bg-[#FFF7E9] rounded-lg">
                <div key={wisata1.id} className="relative">
                    <Link to={`/detailwisata/${wisata1.id}`}> <img src={wisata1.url} alt="" className="rounded-xl p-1 w-full" /> </Link>
            ...
            <div className="bg-[#FFF7E9] rounded-lg">
                <div key={wisata2.id} className="relative">
                    <Link to={`/detailwisata/${wisata2.id}`}> <img src={wisata2.url} alt="" className="rounded-xl p-1 w-full" /> </Link>
