    ...
    return(
        ...
        <div className="mb-5 mx-1 space-y-3 lg:mb-10 xl:mb-24 pt-2">
            ...
            <div className="relative">
                ...
                <h1 className="md:absolute md:bottom-5 md:mx-5 md:px-2 rounded-lg mt-2 bg-slate-400 md:text-white text-center md:text-justify lg:text-md xl:text-3xl py-1 text-[20px] md:text-[16px]">{deskripsi}</h1>
            </div>
        </div>
        </>
    );
